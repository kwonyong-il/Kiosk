...
import com.example.kiosk_final.beerList
import com.example.kiosk_final.burgerList
import com.example.kiosk_final.drinkList
import com.example.kiosk_final.frozenCustardList

fun main() {
    val menuName: ArrayList<String> = arrayListOf("1.Burger", "2.Frozen Custard", "3.Drinks", "4.Beer")
    ...
    while (true) {
        ...
        when (selectNumber) {
            ...
            2 -> { val frozenCustard = FrozenCustard()
                frozenCustardList(frozenCustard)
            }
            3 -> { val drink = Drink()
                drinkList(drink)
            }
